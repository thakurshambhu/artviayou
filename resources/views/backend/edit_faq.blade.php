                            ...
                            <form method="post" action="{{ url('/admin/update_faq') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('qus') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="qus" id="input-name" class="form-control form-control-alternative{{ $errors->has('qus') ? ' is-invalid' : '' }}" placeholder="{{ __('Question') }}" value="{{ $faq->qus }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('ans') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="ans" id="ans" cols="30" rows="10">{{$faq->ans}}</textarea>
