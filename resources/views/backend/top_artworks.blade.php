                                        ...
                                        <table id="datatable" class="table table-striped table-bordered table-responsive-sm" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="{{url('/admin/delete_artwork')}}/{{$artwork->id}}/top_artwork/{{$artwork->user_id}}" class="btn btn-danger btn-link btn-sm delete_artwork" title="Delete Artwork"><i class="fa fa-trash"></i></a>
