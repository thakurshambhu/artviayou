            ...
            <div class="col-md-5">
                <div class="detail">
                    <div class="head justify-content-between">
                        ...
                        <div class="price">
                            @if(count($artwork_result->variants)>0)£{{$artwork_result->variants[0]->price}}@else Sold Out @endif
                        </div>
                    </div>
                    <div class="text">
                        ...
                        <ul>
                            ...
                            <li>Dimensions, @if(count($artwork_result->variants)>0){{$artwork_result->variants[0]->height}} x {{$artwork_result->variants[0]->width}} cm @else Sold Out @endif</li>
