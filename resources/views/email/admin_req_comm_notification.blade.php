                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 10px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        A commission request from  <a href="{{url('profile')}}/{{$data['alias']}}">{{$data['user_name']}}</a> has been Accepted by <a href="{{url('profile_details')}}/{{$data['artist_id']}}">{{$data['artist_name']}}</a>.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 10px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
